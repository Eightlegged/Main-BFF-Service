        ...
        <nav className="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div className="collapse navbar-collapse navbar-ex1-collapse">
                <ul className="nav navbar-nav side-nav">
                    <li>
                        <a href="bootstrap-elements.html"><i className="fa fa-fw fa-desktop"></i> 서비스 소개</a>
                    </li>
                    <li>
                        <a href="tables.html"><i className="fa fa-fw fa-table"></i> 회의 보기</a>
                    </li>
                    <li>
                        <a href="forms.html"><i className="fa fa-fw fa-edit"></i> 회의 생성</a>
                    </li>
                    <li>
                        <a href="index.html"><i className="fa fa-fw fa-dashboard"></i> 대시보드</a>
                    </li>
                </ul>
            </div>
        </nav>
